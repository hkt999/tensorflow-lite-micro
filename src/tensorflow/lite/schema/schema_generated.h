...
enum ActivationFunctionType : int8_t {
  ...
  ActivationFunctionType_MAX = ActivationFunctionType_LEAKY_RELU
};
...
inline const char *EnumNameActivationFunctionType(ActivationFunctionType e) {
  if (flatbuffers::IsOutRange(e, ActivationFunctionType_NONE, ActivationFunctionType_LEAKY_RELU)) return "";
  const size_t index = static_cast<size_t>(e);
